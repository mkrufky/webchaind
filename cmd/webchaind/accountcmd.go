...
webchaind wallet import /path/to/my/presale.wallet
	...
	'$ webchaind account <command> --help' shows help for any subcommand.
...
webchaind account list
	...
	Lists all accounts found in webchaind's keystore.
...
webchaind account new
	...
	For non-interactive use the passphrase can be specified with the --password flag:
		...
		webchaind --password <passwordfile> account new
...
webchaind account update <address>
	...
	For non-interactive use the passphrase can be specified with the --password flag:
		...
		webchaind --password <passwordfile> account update <address>
...
webchaind account import <keyfile>
	...
	For non-interactive use the passphrase can be specified with the -password flag:
		...
		webchaind --password <passwordfile> account import <keyfile>
